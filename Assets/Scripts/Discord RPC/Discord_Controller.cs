...
public class Discord_Controller : MonoBehaviour
{
    ...
    [Space]
    public string details = "Fumo'ing around at the speed of sound";
    public string state = "";
    [Space]
    public string largeImage = "icon";
    public string largeText = "Reimu Fumo Utopia (MOD)";
    ...
    void Start()
    {
        ...
        rb = GameObject.FindWithTag("Character").GetComponent<Rigidbody>();
